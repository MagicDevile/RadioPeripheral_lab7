...
void print_benchmark(volatile unsigned int *periph_base)
{
    ...
    float time_spent =((float)(stop_time-start_time)) / 125000000; // change obviously
	float bytes_transferred = 8192; // change obviously
	float throughput=(bytes_transferred * 1e-6) / time_spent;
...
// first, get a pointer to the peripheral base address using /dev/mem and the function mmap
    ...
    printf("\r\n\r\n\r\nLab 6 Andrew Samuels - Custom Peripheral Demonstration\n\r");
